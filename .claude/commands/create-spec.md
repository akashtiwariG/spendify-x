...
Run `git status` and check for uncommited , unstaged , or untracked files. If any exists , stop immediately and tell the user to commit or stash changes before procedding. Do not continue until the working directory is clean.
